...
#SBATCH --job-name=Langchain_Hard  # Change the name to match the job
...
export TRANSFORMERS_CACHE=/scratch/gilbreth/vciroski/forestry/
export HF_HOME=/scratch/gilbreth/vciroski/forestry/qa_ir/data/squadv2
